...
##                    print speakerFacePortraitStack
            ...
            if not (line.find("type=PARAM,id=45,") == -1):
                ...
                outputLines.append("<img src=\""+navi_chara_collectionDirectory+"dialogueSeparator.png\" align=\"middle\" />")
                outputLines.append("</div>")
                outputLines.append("")
            ...
            if not (line.find("type=PARAM,id=46,") == -1):
                ...
                outputLines.append("<img class=\"deityPortraitFrame\" src=\""+navi_chara_collectionDirectory+"deityFrame.png\" />")
                outputLines.append("<img class=\"deityPortraitImgBack\" src=\""+navi_chara_collectionDirectory+"blank.png\" />")
                outputLines.append("<img class=\"deityPortraitImg\" src=\""+navi_chara_collectionDirectory+"deity.gif\" />")
                outputLines.append("</div>")                
                outputLines.append("</div>")              
                outputLines.append("")
